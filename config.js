...
const windmillConfig = {
  purge: {
    content: ['node_modules/@windmill/react-ui/lib/defaultTheme.js', 'node_modules/@windmill/react-ui/dist/index.js'],
    options: {
      whitelist: ['dark'],
    },
  },
  ...
  plugins: [require('@tailwindcss/ui'), shadowOutlinePlugin],
}
